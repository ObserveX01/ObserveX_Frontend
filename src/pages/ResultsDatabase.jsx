...
const ResultsDatabase = () => {
      ...
      .then((results) => {
        ...
        results.forEach((r) => {
          ...
          if (r.teacherName && r.teacherName !== "NULL" && r.courseName) {
            ...
            teacherStats[r.teacherName].courses.add(
  ...
  const teacherDetails = allResults.filter(
    (r) => (r.teacherName || r.TeacherName) === selectedTeacher?.name,
  );
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex items-center gap-4 mb-10">
            ...
            <div>
              ...
              <p className="text-slate-500 font-medium font-sans">
                Performance tracking across active instructors
              </p>
            </div>
          </div>
          ...
          <div className="bg-white p-8 rounded-[2.5rem] shadow-xl border border-slate-100 mb-10">
            <h3 className="text-lg font-bold text-slate-800 mb-8 flex items-center gap-2">
              <CheckCircle size={20} className="text-[#00c288]" /> Performance
              Overview (Avg Score)
            </h3>
                ...
                <BarChart data={data}>
                  ...
                  <Bar dataKey="avgScore" radius={[10, 10, 0, 0]} barSize={45}>
                    {data.map((entry, index) => (
                      <Cell
                        key={`cell-${index}`}
                        fill={entry.avgScore > 60 ? "#00c288" : "#6366f1"}
                      />
                    ))}
                  </Bar>
                </BarChart>
                ...
                <div className="p-8 bg-slate-900 text-white flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-slate-400 text-sm">
                      Full list of student performance under this instructor
                    </p>
                  </div>
                  <button
                    onClick={() => setSelectedTeacher(null)}
                  ...
                  <table className="w-full text-left border-collapse">
                    ...
                    <tbody className="divide-y divide-slate-50">
                      {teacherDetails.map((res, i) => {
                        const name =
                          res.studentName || res.StudentName || "NULL";
                        const email =
                          res.studentEmail || res.StudentEmail || "N/A";
                        const percentage =
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="py-4 px-2 text-sm text-slate-500 font-medium italic">
                              {email}
                            </td>
