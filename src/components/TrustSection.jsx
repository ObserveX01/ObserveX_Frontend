...
const TrustSection = () => {
  const logos = [
    ...
    },
    {
      ...
      content: (
        <div className="flex items-end gap-1.5 text-obs-gray">
          <span className="text-5xl font-bold lowercase tracking-tighter">
            e
          </span>
          <div
    ...
    },
    {
      ...
      content: (
        <div className="flex items-center gap-4 text-obs-gray">
          <span className="text-4xl font-serif font-light tracking-tight">
            UWS
          </span>
      ...
      content: (
        <div className="flex items-center gap-4 text-obs-gray">
          ...
          <div
            ...
            style={{
              clipPath:
                "polygon(0 0, 100% 0, 100% 100%, 40% 100%, 40% 40%, 0 40%)",
            }}
          ></div>
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="flex items-center gap-4 text-obs-gray">
          <div className="border-[3px] border-obs-gray px-2 py-1 text-3xl font-black leading-none">
            DB
          </div>
      ...
      content: (
        <div className="relative flex items-center justify-center border-[4px] border-obs-gray rounded-full w-24 h-20 text-obs-gray">
          <div className="text-center leading-none">
            <div className="text-[15px] font-serif italic font-bold">
              Hard Rock
            </div>
    ...
    },
    {
      ...
      content: (
        <div className="border-[4px] border-obs-gray p-2.5 flex flex-col items-center justify-center leading-none text-obs-gray">
          <span className="text-[20px] font-black uppercase tracking-tighter">
            Liqui
          </span>
          <span className="text-[24px] font-black uppercase tracking-tighter">
            Moly
          </span>
        </div>
      ),
    ...
    <section className="bg-white py-24 overflow-hidden select-none">
      <div className="max-w-7xl mx-auto px-6 text-center mb-24">
        <h2 className="text-3xl md:text-5xl font-bold text-obs-dark mb-6">
          Create online{" "}
          <span className="underline decoration-obs-dark/20 decoration-4 underline-offset-8">
            tests
          </span>
          ,{" "}
          <span className="underline decoration-obs-dark/20 decoration-4 underline-offset-8">
